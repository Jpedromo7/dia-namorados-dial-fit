    ...
    <main className="campaign-bg relative min-h-screen px-5 py-7 text-white sm:px-7">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-7">
        ...
        <section className="campaign-frame p-6 sm:p-8">
          ...
          <div className="mt-7 grid gap-3 sm:grid-cols-2"><div className="campaign-frame-soft p-4"><p className="text-xs font-bold uppercase tracking-[0.12em] text-[#55e814]">Sorteio</p><p className="mt-2 font-bold text-white">{DRAW_DATE_LABEL}</p></div><div className="campaign-frame-soft p-4"><p className="text-xs font-bold uppercase tracking-[0.12em] text-[#55e814]">Premiação</p><p className="mt-2 font-bold text-white">3 prêmios · 3 vencedores</p></div></div>
        </section>
